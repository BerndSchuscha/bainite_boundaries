...
from models.NeuralNetwork import NeuralNetworkModel, NeuralNetworkClassification
...
for which_data in which_data_list:
    ...
    x_test_final, y_test_austensite, features_final = load_dataset('final',which_data)
    ...
    'Bainite': ['linear'],#,'polynomial','GP','GP_Poly','RF','XGB_no_monotonic','LGBM_no_monotonic','GP_linearmean','NN'],
    # 'Bainite': ['GP'],
    ...
    'Martensite_start_RA':['GP_linearmean','monoton_neural'],
    ...
    CP_params = {
        ...
        'distance_loc': 'input',  # PCA, PCA_scaled, input, input_scaled
        'n_neighbors': 5
    }
    ...
    model_dict = {
        ...
        'SVC_class': SVC(kernel='rbf', C=1, gamma='scale', probability=True),
        ...
        'neural_class': NeuralNetworkClassification(**model_parameters['neural_class'])
    }
